...
import filipetrinidad.metatomo.databinding.ActivityClassificacaoCopoMacroscopicoBinding
...
class ClassificacaoCopoMacroscopico : AppCompatActivity() {

    private var _binding: ActivityClassificacaoCopoMacroscopicoBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityClassificacaoCopoMacroscopicoBinding.inflate(layoutInflater)
