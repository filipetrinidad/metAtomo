...
import filipetrinidad.metatomo.databinding.ActivityClassificacaoBinding
...
class Classificacao : AppCompatActivity() {
    ...
    private var _binding: ActivityClassificacaoBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityClassificacaoBinding.inflate(layoutInflater)
    ...
    fun classifyImage(image: Bitmap) {
        try {
            ...
            if(resultado == "Água - Submicroscópico"){
                quizCerto("Correto",
                "$resultado",
                    R.drawable.bg_verde,
                    R.drawable.verifica,
                ...
                quizErrado("Errado",
                "O desenho não representa uma molécula de água no nivel submicroscópico. O nível submicroscópico simboliza os átômos em formatos de esfera. \n" +
    ...
    private fun quizCerto(titulo: String, corpo: String, bolaFundoBack: Int, bolaFundoImage: Int, btnCor: Int){
        ...
        btn_confirmar.setOnClickListener {
            dialog.dismiss()
            val i = Intent(this, ClassificacaoAguaSimbolico::class.java )
            startActivity(i)
        }
    }
