package filipetrinidad.metatomo.activies.agua
...
import filipetrinidad.metatomo.databinding.ActivityClassificacaoCopoSubmacroscopicoBinding
...
class ClassificacaoCopoSubmacroscopico : AppCompatActivity() {

    private var _binding: ActivityClassificacaoCopoSubmacroscopicoBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityClassificacaoCopoSubmacroscopicoBinding.inflate(layoutInflater)
    ...
    private fun quizCerto(titulo: String, corpo: String, bolaFundoBack: Int, bolaFundoImage: Int, btnCor: Int){
        ...
        btn_confirmar.setOnClickListener {
            dialog.dismiss()
            val i = Intent(this, ClassificacaoCopoSubmacroscopico::class.java )
            startActivity(i)
        }
    }
